...
- **分层门禁：`wink lint`（ADR-0043）**: App/BAL/DAL/PAL 边界与 API 形态由 `tools/lint/rules/*.yaml` 驱动；生成或修改 C 代码后应运行 `python wink-micro-os/tools/wink.py lint --pack layering --pack api`。
