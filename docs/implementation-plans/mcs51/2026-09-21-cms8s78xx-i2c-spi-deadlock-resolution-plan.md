...
| **计划状态** | 🟢 Phase 1 已完成；🟡 Phase 2 进行中（T2.0 ABI/hash 同步、T2.1 `i2c_eeprom`、T2.2a ADR-0087、T2.2 `spi_eeprom` 均已落地；待 T2.3 双仓联调（I2C/SPI 会话路由 + 快照）、T2.4 数据实证、T2.5 摘牌、T2.6 回写） |
