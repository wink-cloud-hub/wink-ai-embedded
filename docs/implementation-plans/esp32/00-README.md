...
| 子计划 | 里程碑 | 状态 | 文档路径 |
| :--- | :--- | :--- | :--- |
| M0 骨架与最小 GPIO 闭环 | M0 | 📋 就绪执行中 (v1.3 lint 引擎形态双通道) | [2026-09-23-esp-idf-sim-m0-gpio-plan.md](./2026-09-23-esp-idf-sim-m0-gpio-plan.md) |
| M1 FreeRTOS 调度器 Shim | M1 | 📋 待开始 (v1.2 占位+展开约束) | [2026-09-24-esp-idf-sim-m1-freertos-plan.md](./2026-09-24-esp-idf-sim-m1-freertos-plan.md) |
