...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/02-virtual-clock.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/02-virtual-clock.md)
...
Specification of the 64-bit BigInt microsecond monotonic timebase and step catch-up policies.
