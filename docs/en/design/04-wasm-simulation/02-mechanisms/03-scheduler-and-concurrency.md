# Cooperative Scheduler and Concurrency
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/03-scheduler-and-concurrency.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/03-scheduler-and-concurrency.md)
...
Specification of the single virtual core model, cooperative execution, and WCET timeout guards.
