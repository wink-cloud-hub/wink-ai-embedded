# Wasm <-> JS Bridge ABI Specification
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/10-wasm-js-bridge-abi.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/10-wasm-js-bridge-abi.md)
...
Specification of C exported symbols, JS imports, and cross-language memory layouts.
