...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/01-sandbox-and-execution.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/01-sandbox-and-execution.md)
...
Specification of the Emscripten Wasm sandbox, Asyncify suspension, and INTERACTIVE vs HEADLESS execution modes.
