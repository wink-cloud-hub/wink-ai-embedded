# Bidirectional Closed-Loop Simulation
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/12-bidirectional-high-fidelity-closed-loop.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/12-bidirectional-high-fidelity-closed-loop.md)
...
Specification of controller output driving virtual physics and plant feedback loops.
