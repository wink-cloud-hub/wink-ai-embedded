# Interrupt and Critical Section Model
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/04-interrupt-model.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/04-interrupt-model.md)
...
Specification of interrupt event queues, priority arbitration, latency injection, and ISR safe boundaries.
