# Physical Degradation and Fault Injection
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/06-physical-degradation.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/06-physical-degradation.md)
...
Specification of brownout reset, clock jitter, contact bounce, and packet drop degradation models.
