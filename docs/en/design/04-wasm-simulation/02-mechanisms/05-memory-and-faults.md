# Memory Quota and Fault Isolation
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/05-memory-and-faults.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/05-memory-and-faults.md)
...
Specification of Wasm memory quotas, heap guard pages, runtime Fault latching, and actuator safe-off protection.
