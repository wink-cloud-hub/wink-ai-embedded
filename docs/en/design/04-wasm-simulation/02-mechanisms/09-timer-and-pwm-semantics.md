# Timer and PWM Modulation Semantics
...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/en/09-timer-and-pwm-semantics.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/en/09-timer-and-pwm-semantics.md)
...
Specification of behavioral soft-stepping, duty cycle capture, and hardware timer mappings.
