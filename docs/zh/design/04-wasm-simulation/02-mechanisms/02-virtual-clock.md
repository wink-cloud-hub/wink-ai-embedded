...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/02-virtual-clock.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/02-virtual-clock.md)
...
定义 64 位 BigInt 微秒级无漂移单调时基、离散事件步进推进与时间追赶策略。
