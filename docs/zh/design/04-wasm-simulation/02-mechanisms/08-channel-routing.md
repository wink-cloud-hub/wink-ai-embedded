...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/08-channel-routing.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/08-channel-routing.md)
...
定义 Channel 1 (GPIO), 1b (PWM), 2 (Bus I2C/SPI), 3 (ADC) 与 4 (Buffer) 的数据流路由。
