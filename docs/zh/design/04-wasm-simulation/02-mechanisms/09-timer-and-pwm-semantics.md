...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/09-timer-and-pwm-semantics.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/09-timer-and-pwm-semantics.md)
...
定义行为级软步进（soft-stepping）、PWM 占空比与基础频率捕获以及 hardware timer 映射。
