...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/12-bidirectional-high-fidelity-closed-loop.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/12-bidirectional-high-fidelity-closed-loop.md)
...
定义控制器输出驱动虚拟物理模型、物理世界反馈闭环回路的同源闭合机制。
