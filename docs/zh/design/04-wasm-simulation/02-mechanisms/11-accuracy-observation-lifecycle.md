...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/11-accuracy-observation-lifecycle.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/11-accuracy-observation-lifecycle.md)
...
定义 L1 状态机与 L2 数据面精度等级、PinTracer 实时追踪与 VCD 观测导出。
