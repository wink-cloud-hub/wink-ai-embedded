...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/10-wasm-js-bridge-abi.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/10-wasm-js-bridge-abi.md)
...
定义 C 侧导出符号、JS 桩函数导入规范以及跨语言内存布局单一事实来源。
