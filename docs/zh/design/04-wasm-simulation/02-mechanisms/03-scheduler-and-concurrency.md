...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/03-scheduler-and-concurrency.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/03-scheduler-and-concurrency.md)
...
定义单虚拟核心模型、协作式轮询调度、时间片守卫（WCET）与看门狗机制。
