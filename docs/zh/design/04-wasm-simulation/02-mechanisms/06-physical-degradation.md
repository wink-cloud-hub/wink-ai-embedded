...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/06-physical-degradation.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/06-physical-degradation.md)
...
定义欠压重启、时钟抖动、引脚接触不良与通信丢包等三层故障注入模型。
