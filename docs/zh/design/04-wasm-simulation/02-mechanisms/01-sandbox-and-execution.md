...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/01-sandbox-and-execution.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/01-sandbox-and-execution.md)
...
定义 Emscripten Wasm 沙箱、Asyncify 协程挂起、INTERACTIVE 与 HEADLESS 执行模式。
