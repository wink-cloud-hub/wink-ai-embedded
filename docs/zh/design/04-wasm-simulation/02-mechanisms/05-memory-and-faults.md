...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/05-memory-and-faults.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/05-memory-and-faults.md)
...
定义 Wasm 内存配额限制、堆栈溢出守卫、运行时 Fault 锁存与执行器 safe-off 保护。
