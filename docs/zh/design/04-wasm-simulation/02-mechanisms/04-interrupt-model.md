...
>   [`docs/.internals/packages/unisim/docs/internals/mechanisms/04-interrupt-model.md`](../../../../.internals/packages/unisim/docs/internals/mechanisms/04-interrupt-model.md)
...
定义中断事件队列、优先级仲裁、中断延迟注入与任务/ISR 双入口安全边界。
