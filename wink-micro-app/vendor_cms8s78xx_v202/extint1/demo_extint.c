...
void EXTINT_Config(void)
{
	...
	*/
	...
	(2)设置EXTINT IO口
	*/	
	GPIO_SET_MUX_MODE(P31CFG, GPIO_MUX_GPIO);			//设置P31为GPIO模式
	GPIO_ENABLE_INPUT(P3TRIS, GPIO_PIN_1);				//设置为输入模式	
	GPIO_ENABLE_UP(P3UP, GPIO_PIN_1);					//开启P31上拉
	GPIO_SET_PS_MODE(PS_INT1, GPIO_P31_MUX_INT1);		//复用为INT1 输入功能
	/*
	(3)设置EXTINT中断
	*/		
