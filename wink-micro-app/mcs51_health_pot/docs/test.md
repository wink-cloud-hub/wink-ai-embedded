...
| 17 | [`health-pot-fast-boil.scenario.json`](file:///D:/workspaces/ai-coding/wink-ai/wink-ai-embedded/wink-micro-app/mcs51_health_pot/unisim-scenarios/health-pot-fast-boil.scenario.json) | **Phase-B Plant 自激闭环**：0.3L/1000W 一阶热力学模型自发烧开（~94s）→ 3s 确认 → 保温；场景零温度轨迹注入（ADR-0067 激励源互斥） | Plant 自激反馈、继电器切断落于 (92s,99s)、遥测 `S=1` → `S=2` |
