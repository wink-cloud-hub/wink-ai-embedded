...
> **应用目录**：`wink-micro-app/vendor_cms8s78xx_v202_extint0`  
...
python packages/wink-tools/wink.py build sim --app vendor_cms8s78xx_v202_extint0
```
> **检查输出**：执行后会在 `wink-micro-app/vendor_cms8s78xx_v202_extint0/unisim-assets/` 下生成：
...
```powershell
cd D:\workspaces\ai-coding\wink-ai\wink-ai
python packages/wink-tools/wink.py sim run --app vendor_cms8s78xx_v202_extint0
```
...
python packages/wink-tools/wink.py sim run `
  --app vendor_cms8s78xx_v202_extint0 `
  --mode headless `
  --scenarios ../wink-ai-embedded/wink-micro-app/vendor_cms8s78xx_v202_extint0/unisim-scenarios/extint0.scenario.json
```
