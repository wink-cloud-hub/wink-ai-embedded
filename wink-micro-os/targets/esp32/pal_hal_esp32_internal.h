 ...
 * (pal_hal_esp32.c, pal_hal_esp32_gpio.c, pal_hal_esp32_pwm.c,
 * pal_hal_esp32_i2c.c, pal_irq_esp32.c) after the split introduced by
 ...
 * pal_hal_esp32_gpio.c. Rather than exposing the array itself across TUs
 ...
 * to pal_hal_esp32_gpio.c and preserves R-5 write-path semantics unchanged.
 */
#ifndef WINK_TARGETS_ESP32_PAL_HAL_ESP32_INTERNAL_H
#define WINK_TARGETS_ESP32_PAL_HAL_ESP32_INTERNAL_H
 ...
 * pal_hal_esp32_gpio.c and returns once every pin's counter has been observed
...
#endif /* WINK_TARGETS_ESP32_PAL_HAL_ESP32_INTERNAL_H */
