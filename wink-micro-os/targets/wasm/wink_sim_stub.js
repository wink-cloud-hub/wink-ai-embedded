...
if (isMainThread) {
    ...
    const knownBridgeSymbols = [
        ...
        'js_pal_i2c_transfer',
        'js_pal_i2c_transfer_ex',
        'js_pal_i2c_session_open',
        'js_pal_i2c_session_restart',
        'js_pal_i2c_session_write',
        'js_pal_i2c_session_read',
        'js_pal_i2c_session_close',
        'js_pal_spi_transfer',
        'js_pal_spi_transfer_ex',
        'js_pal_spi_session_open',
        'js_pal_spi_session_transfer',
        'js_pal_spi_session_close',
        'js_pal_uart_write',
        'js_pal_rmt_tx',
        ...
        'js_pal_log',
        'js_pal_pcnt_edge',
        'js_pal_mcpwm_capture_edge',
        'js_pal_mcpwm_get_duty_ticks',
