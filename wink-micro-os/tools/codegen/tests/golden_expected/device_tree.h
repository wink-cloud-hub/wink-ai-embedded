...
WINK_WARN_UNUSED_RESULT static inline wink_status_t smoke_sonar_enable_distance_events(void) { static const wink_ultrasonic_distance_event_config_t cfg = { .period_ms = 50u }; return wink_ultrasonic_enable_distance_events(&smoke_sonar, &cfg); }
static inline void smoke_sonar_disable_distance_events(void) { wink_ultrasonic_disable_distance_events(&smoke_sonar); }
