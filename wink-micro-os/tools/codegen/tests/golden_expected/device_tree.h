...
_Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"") WINK_WARN_UNUSED_RESULT static inline wink_status_t boot_button_start_auto_poll(uint32_t poll_ms) { return wink_button_helper_start(&boot_button, poll_ms); } _Pragma("GCC diagnostic pop")
_Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"") static inline void boot_button_stop_auto_poll(void) { (void)wink_button_helper_stop(&boot_button); } _Pragma("GCC diagnostic pop")
