 ...
 * Do not edit manually 鈥?changes will be overwritten on next build.
 */
...
/* 鈹€鈹€ Instance count macros (slots allocation) 鈹€鈹€ */
...
/* 鈹€鈹€ Driver configuration constants 鈹€鈹€ */
...
/* 鈹€鈹€ Device instance handles (extern; business code accesses by name) 鈹€鈹€ */
extern dal_led_t board_led;
extern dal_button_t boot_button;
extern dal_ultrasonic_t smoke_ultrasonic;

/* 鈹€鈹€ Role-based instance APIs (static inline) 鈹€鈹€ */
 ...
 *
 * Actuators are unregistered first (in forward init order 鈥?the inverse of
 * the reverse-order register list 鈥?so the stack discipline matches). Then
