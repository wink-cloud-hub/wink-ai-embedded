...
static const char *const OWNER = "test_dal_servo";
...
void test_init_null_returns_invalid_arg(void) {
    dal_servo_config_t cfg = { .owner = OWNER, .pwm_channel = 0, .min_pulse_ms = 0.5f, .max_pulse_ms = 2.5f };
...
void test_init_rejects_invalid_pulse_range(void) {
    dal_servo_t dev = {0};
    dal_servo_config_t zero_min  = { .owner = OWNER, .pwm_channel = 0, .min_pulse_ms = 0.0f, .max_pulse_ms = 2.5f };
    dal_servo_config_t inverted  = { .owner = OWNER, .pwm_channel = 0, .min_pulse_ms = 2.5f, .max_pulse_ms = 0.5f };
...
void test_init_then_set_angle_clamps_overflow(void) {
    dal_servo_t s = {0};
    dal_servo_config_t cfg = { .owner = OWNER, .pwm_channel = 1, .min_pulse_ms = 0.5f, .max_pulse_ms = 2.5f };
    TEST_ASSERT_EQUAL_INT(WINK_OK, dal_servo_init(&s, &cfg));
...
void test_safe_off_after_init_sets_zero_duty(void) {
    dal_servo_t s = {0};
    dal_servo_config_t cfg = { .owner = OWNER, .pwm_channel = 2, .min_pulse_ms = 0.5f, .max_pulse_ms = 2.5f };
    TEST_ASSERT_EQUAL_INT(WINK_OK, dal_servo_init(&s, &cfg));
