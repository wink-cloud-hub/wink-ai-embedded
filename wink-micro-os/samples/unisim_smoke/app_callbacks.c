...
#include "pal_ultrasonic.h" /* pal_hal_ultrasonic_trigger */
...
static void app_init(void)
{
     ...
     *     pal_hal_ultrasonic_trigger -> js_sim_trigger_ultrasonic
    ...
    (void)pal_hal_ultrasonic_trigger(SMOKE_ULTRASONIC_TRIG);
    uint32_t pulse_us = 0;
