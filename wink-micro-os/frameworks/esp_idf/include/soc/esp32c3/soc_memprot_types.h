...
#ifndef WINK_H_GUARD_SOC_ESP32C3_SOC_MEMPROT_TYPES_H
#define WINK_H_GUARD_SOC_ESP32C3_SOC_MEMPROT_TYPES_H
#ifndef __WINK_HARVESTED_SOC_ESP32C3_SOC_MEMPROT_TYPES_H__
#define __WINK_HARVESTED_SOC_ESP32C3_SOC_MEMPROT_TYPES_H__
#include <stdint.h>
#include <stdbool.h>
#include <stddef.h>
#include "wink_sla.h"
...
typedef enum {
    MEMPROT_TYPE_NONE = 0,
    MEMPROT_TYPE_IRAM0_SRAM = 1,
    MEMPROT_TYPE_DRAM0_SRAM = 2,
    MEMPROT_TYPE_IRAM0_RTCFAST = 4,
    MEMPROT_TYPE_ALL = 2147483647,
    MEMPROT_TYPE_INVALID = 2147483648,
    MEMPROT_TYPE_IRAM0_ANY = 5,
} esp_mprot_mem_t;
typedef enum {
    MEMPROT_SPLIT_ADDR_NONE = 0,
    MEMPROT_SPLIT_ADDR_IRAM0_DRAM0 = 1,
    MEMPROT_SPLIT_ADDR_IRAM0_LINE_0 = 2,
    MEMPROT_SPLIT_ADDR_IRAM0_LINE_1 = 4,
    MEMPROT_SPLIT_ADDR_DRAM0_DMA_LINE_0 = 8,
    MEMPROT_SPLIT_ADDR_DRAM0_DMA_LINE_1 = 16,
    MEMPROT_SPLIT_ADDR_ALL = 2147483647,
    MEMPROT_SPLIT_ADDR_INVALID = 2147483648,
    MEMPROT_SPLIT_ADDR_MAIN = 1,
} esp_mprot_split_addr_t;
typedef enum {
    MEMPROT_PMS_AREA_NONE = 0,
    MEMPROT_PMS_AREA_IRAM0_0 = 1,
    MEMPROT_PMS_AREA_IRAM0_1 = 2,
    MEMPROT_PMS_AREA_IRAM0_2 = 4,
    MEMPROT_PMS_AREA_IRAM0_3 = 8,
    MEMPROT_PMS_AREA_DRAM0_0 = 16,
    MEMPROT_PMS_AREA_DRAM0_1 = 32,
    MEMPROT_PMS_AREA_DRAM0_2 = 64,
    MEMPROT_PMS_AREA_DRAM0_3 = 128,
    MEMPROT_PMS_AREA_IRAM0_RTCFAST_LO = 256,
    MEMPROT_PMS_AREA_IRAM0_RTCFAST_HI = 512,
...
#endif
#endif /* __WINK_HARVESTED_SOC_ESP32C3_SOC_MEMPROT_TYPES_H__ */
#endif /* WINK_H_GUARD_SOC_ESP32C3_SOC_MEMPROT_TYPES_H */
