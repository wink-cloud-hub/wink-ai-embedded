/**
 * @file wink_servo_sweep.h
 * @brief BAL: sweep and control a DAL servo via the runtime scheduler.
 *
 * Copyright (c) 2026 Wink-AI.
 */
#ifndef WINK_SERVO_SWEEP_H
#define WINK_SERVO_SWEEP_H
...
#ifndef WINK_SERVO_SWEEP_MAX
# ifdef WINK_APP_MAX_SERVO_INSTANCES
#  define WINK_SERVO_SWEEP_MAX WINK_APP_MAX_SERVO_INSTANCES
# else
#  define WINK_SERVO_SWEEP_MAX 4
# endif
#endif
